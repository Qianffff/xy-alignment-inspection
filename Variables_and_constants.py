...
SNR = 10
pixel_width_x = 5*1e-9 # Pixel size (in m)
...
pixel_width_real_x = pixel_width_x
while pixel_width_real_x > pixel_width_real_x_max: pixel_width_real_x = pixel_width_real_x/2
pixel_width_real_y = pixel_width_y
while pixel_width_real_y > pixel_width_real_y_max: pixel_width_real_y = pixel_width_real_y/2
